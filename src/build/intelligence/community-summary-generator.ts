 ...
 *
 * Generates natural-language summaries for graph communities (clusters of related symbols).
 * Two modes:
...
export class CommunitySummaryGenerator {
   ...
   * Respects max_number config to limit how many communities are summarized.
   */
